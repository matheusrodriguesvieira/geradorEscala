...
function salvarParametros() {
    // if (localStorage.getItem('listaEscalas') != null) {
    //     let local = JSON.parse(localStorage.getItem('listaEscalas'));
    //     let operadoresBD = operadores;
    //     let equipamentosBD = equipamentos;
    //     let listaEscalasBD = [listaEscalas[0]];

    //     // console.log(local);
    //     // listaEscalasBD = local.unshift(listaEscalasBD);
    //     local.forEach(element => {
    //         listaEscalasBD.push(element);
    //     })
    //     // local.unshift(listaEscalasBD);

    //     console.log('com dados no local storage');
    ...
    // } else {
    //     console.log('sem dados no local storage');
    //     console.log('salvando...');
